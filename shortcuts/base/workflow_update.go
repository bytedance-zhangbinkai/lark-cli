...
var BaseWorkflowUpdate = common.Shortcut{
	...
	Validate: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		if _, err := parseWorkflowBodyJSON(runtime, workflowWriteUpdate); err != nil {
			return err
		}
		return nil
	},
	DryRun: func(ctx context.Context, runtime *common.RuntimeContext) *common.DryRunAPI {
		...
		body, _ = parseWorkflowBodyJSON(runtime, workflowWriteUpdate)
	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		body, err := parseWorkflowBodyJSON(runtime, workflowWriteUpdate)
		if err != nil {
			return err
		}
