...
var BaseWorkflowUpdate = common.Shortcut{
	...
	Tips: []string{
		...
		"AIClassificationBranch update accepts the same public Agent Data shape returned by +workflow-get; keep mode/classes/content/classification_rule/no_match_action.",
